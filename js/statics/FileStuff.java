...
public class FileStuff {
	public static void fileMatrixTrans( int[][] matrix1 , String filename,  String legend){
	   ...
	   public static void fileMatrixRow( double[] matrixRow , String filename){
	        try
	        {
	            String fileName = filename+".txt";
	            FileWriter fileWriter = new FileWriter( fileName,true);
	       ...
	       //     bufferedWriter.write(filename+ legend );
	         //   bufferedWriter.newLine();
	                ...
	                {
	                    matrixRowString = matrixRowString+String.format("%.8f",matrixRow[j])+"\t";;
	                //    System.out.println( matrixRow );
	                }
	                System.out.println( matrixRowString );
	                bufferedWriter.write( matrixRowString );
	               bufferedWriter.newLine();
	                bufferedWriter.flush();
	   ...
	   public static void fileMatrix( double[][] matrix , String filename){
	        try
	        {
	            String fileName = filename+".txt";
	            FileWriter fileWriter = new FileWriter( fileName,true);
	   ...
	   public static void fileMatrixDouble( double[][] matrix , String filename){
	        try
	        {
	            String fileName = filename+".txt";
	            FileWriter fileWriter = new FileWriter( fileName,true);
	   ...
	   public static void fileSentenceNoNewLine(String filename,  String legend){
	        try
	        { // System.out.println( legend );
	            String fileName = filename+".txt";
	            FileWriter fileWriter = new FileWriter( fileName,true);  
	...
	public static void fileVectors(int[] m1, int[] m2, int[] v1, int[] v2, String filename, int minR,int minAll){	 
		...
		public static void fileVectorNew(double[] m, String filename) {
			try
	        {
	            String fileName = filename+".txt";
	            FileWriter fileWriter = new FileWriter( fileName,true);
